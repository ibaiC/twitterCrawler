...
# output in the form of cluster# and the array of the tweetids in that cluster. # Also make clusters count graph.
...
print("Clustered Tweets in the format: Cluster [tweet_ids...]" , file = f)
